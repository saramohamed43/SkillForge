...
public class SkillForge {
    ...
    private static void createCourse(Instructor instructor) {
        ...
        if (success) {
            ...
            System.out.println("❌ Failed to create course. Course ID might already exist.");
        }
    }
    ...
    private static void editCourse() {
        ...
        if (newTitle.isEmpty()) {
            newTitle = course.getCourseTitle();
        }
        ...
        if (newDesc.isEmpty()) {
            newDesc = course.getCourseDescription();
        }

        boolean success = instructorManager.editCourse(courseId, newTitle, newDesc);
